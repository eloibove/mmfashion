...
fit(online_train_loader, online_test_loader, model, loss_fn, optimizer, scheduler, n_epochs, cuda, log_interval, model_name='siamese_hnm_8_12')
print('done training')

torch.save(model.state_dict(), './checkpoint/siamese_hnm_100_epochs_8_12.pth')
